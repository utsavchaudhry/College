...
/**
 Generate a Blue Rectangle as a Bitmap
...
int main(int argc, char** argv)
{
	...
	//Make Every Pixel the Same Color
	//Blue Selected using https://www.w3schools.com/colors/colors_picker.asp
	//Use the RGB codes
	unsigned char myRed = 102;
	unsigned char myGreen = 204;
	unsigned char myBlue = 255;
	
	//Just make Every pixel the same color
	setColor(red,myRed,pixels);
	setColor(green,myGreen,pixels);
	setColor(blue,myBlue,pixels);
